...
<div class="container header-top">
            <div class="row variable-gutters">
                <div class="col-8 d-flex align-items-center">
                    ...
                    <!-- Left menu element-->
                    <div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left perfect-scrollbar ps-container ps-theme-default" data-ps-id="1acb7e19-5c25-0cdb-21cb-25d8193cd5c8">
                        ...
                        <div class="nav-list-mobile dl-menuwrapper">
                            <nav aria-label="Principale">
                                <ul class="dl-menu nav-list nav-list-primary" data-element="menu">
                                            ...
                                            <a class="toggle-dropdown toggle-dropdown-simple active" role="button" href="#" aria-expanded="false" id="mainNavDropdownMobile1" title="Vai alla pagina: Scuola" aria-hidden="true" tabindex="-1">Scuola</a>
...
<li><a href="https://www.liceopitagoracrotone.edu.it/servizio/" aria-hidden="true" tabindex="-1">Tutti i servizi</a></li>
                                            ...
                                            <a class="toggle-dropdown toggle-dropdown-simple " role="button" href="#" aria-expanded="false" id="mainNavDropdownMobile3" title="Vai alla pagina: Novità" aria-hidden="true" tabindex="-1">Novità</a>
